...
# ==========================================
    ...
    * **📝 Kuis Tata Nama:** Evaluasi interaktif satu per satu soal.
    ...
    # ==========================================
    # ==============================================================================
    # TAB 2: LAB REAKSI ORGANIK (PERBAIKAN RUMUS KUSTOM + PUSTAKA LENGKAP UTUH)
    # ==============================================================================
    with tab2:
        ...
        # --- BAGIAN 2: PUSTAKA REAKSI KIMIA ORGANIK LENGKAP (FITUR LAMA ANDA) ---
        ...
        pustaka_opsi = st.selectbox(
            "Pilih Contoh Reaksi Kimia dari Database:",
            ["1. Alkilasi Friedel-Crafts (Benzena + CH3Cl)"]
        )
        
        if "Alkilasi Friedel-Crafts" in pustaka_opsi:
            st.markdown("""
            <div style="background-color: #fff5f5; padding: 20px; border-radius: 12px; border: 1.5px solid #ff7675; margin-top:15px; margin-bottom: 15px;">
                <h4 style="color: #d63031; margin-top:0; font-weight: bold;">🧪 Alkilasi Friedel-Crafts (Substitusi Elektrofilik)</h4>
                <p style="margin-bottom: 0;">Reaksi ini berfungsi memasukkan gugus alkil ke dalam inti Benzena yang kaya elektron menggunakan katalis asam Lewis.</p>
            </div>
            """, unsafe_allow_html=True)
            
            # Rumus Kimia Friedel-Crafts bawaan Anda yang rapi
